...
var PostList = function (_React$Component) {
  ...
  (0, _createClass3.default)(PostList, [{
    ...
    value: function render() {
      return _react2.default.createElement(_Box2.default, { pt: _config.spacing[3], pb: _config.spacing[3] }, this.props.post.filter(function (post) {
        return post.private != true;
      }).map(function (post, i) {
        return _react2.default.createElement(_StyledLink2.default, {
